# Note: Shrinkcovmat 1-4.0 used here is the latest version on CRAN
# but there is a more recent version on github avalaible (that changed the function call)


# setwd("/Users/julia/Documents/Arbeit/Promotion/Forschung/Projects/02_WFcovreg/Manuscript/code")
# run OS_Rcode.R

################################################################################
## Table 1: Model Parameter Estimates of Intercept-Only Model for Example Data Set
...
# quick_latex(table, file="/Users/julia/Documents/Arbeit/Promotion/Forschung/Projects/02_WFcovreg/Manuscript/tables/MS_tab1.tex")
